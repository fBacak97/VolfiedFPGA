...
set_property PACKAGE_PIN V17 [get_ports {rightSwitch}]    
        set_property IOSTANDARD LVCMOS33 [get_ports {rightSwitch}]
        
set_property PACKAGE_PIN W17 [get_ports {leftSwitch}]    
        set_property IOSTANDARD LVCMOS33 [get_ports {leftSwitch}]
        
set_property PACKAGE_PIN W16 [get_ports {upSwitch}]    
        set_property IOSTANDARD LVCMOS33 [get_ports {upSwitch}]
        
set_property PACKAGE_PIN V16 [get_ports {downSwitch}]    
        set_property IOSTANDARD LVCMOS33 [get_ports {downSwitch}]   
